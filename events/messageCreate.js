...
module.exports = {
  ...
  async execute(client, message) {
    ...
    currentXp = (await client.xpDB.get(`${message.author.id}_currentXp`)) | 0;
    ...
    if (newXp >= (currentLevel + 1) * 10) {
      ...
      await client.xpDB.set(`${message.author.id}_currentLevel`, newLevel);

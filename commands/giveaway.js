    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("durée")
            .setDescription("La durée du giveaway. Exemple : 10s, 1h, 3d.")
            .setRequired(true)
        )
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("giveaway")
            .setDescription("Le giveaway à terminer (ID de message).")
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("giveaway")
            .setDescription("Le giveaway à mettre en pause (ID de message).")
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("giveaway")
            .setDescription("Le giveaway à relancer (ID de message).")
            .setRequired(true)
        )
    ),

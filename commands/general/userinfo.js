        ...
        if (user !== null) {
            ...
            replyembed = new EmbedBuilder()
                ...
                .addFields(
                    { name: "Robot", value: user.bot === true ? "Oui" : "Non" },
                    {
                        ...
                        value:
                            "<t:" +
                            Math.floor(user.createdTimestamp / 1e3) +
                            ":f>",
                    },
                    ...
                    { name: "ID", value: user.id },
                    {
                        ...
                        value:
                            "<t:" +
                            Math.floor(member.joinedTimestamp / 1e3) +
                            ":f>",
                    }
                )
            ...
            replyembed = new EmbedBuilder()
                ...
                .addFields(
                    {
                        name: "Robot",
                        value: usender.bot === true ? "Oui" : "Non",
                    },
                    {
                        name: "Compte créé le :",
                        value:
                            "<t:" +
                            Math.floor(usender.createdTimestamp / 1e3) +
                            ":f>",
                    },
                    { name: "Status", value: memberstatus },
                    ...
                    { name: "ID", value: usender.id },
                    {
                        ...
                        value:
                            "<t:" +
                            Math.floor(msender.joinedTimestamp / 1e3) +
                            ":f>",
                    }
                )

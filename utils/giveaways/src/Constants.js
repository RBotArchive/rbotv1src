...
exports.LastChanceOptions = {
  enabled: false,
  content: "⚠️ **DERNIÈRE CHANCE D'ENTRER** ⚠️",
  threshold: 10_000,
  embedColor: "#FF0000",
};
...
exports.GiveawayRerollOptions = {
  ...
  messages: {
    congrat:
      ":tada: Nouveaux gagnant(s): {winners}! Bravo, vous avez gagné **{this.prize}**!\n{this.messageURL}",
    error:
      "Pas assez de participations valides, pas de nouveau(x) gagnant(s) ne peu(ven)t être choisi(s) !",
